...
export type KeyboardAwareHOCProps = {
  ...
  innerRef?: Function,
  heightAboveComponentScrollFix:number,
...
const ScrollIntoViewDefaultOptions: KeyboardAwareHOCOptions = {
  ...
  heightAboveComponentScrollFix:10,
...
function KeyboardAwareHOC(
  ...
  return class
    ...
    static propTypes = {
      ...
      heightAboveComponentScrollFix:PropTypes.number,
    ...
    static defaultProps = {
      heightAboveComponentScrollFix:hocOptions.heightAboveComponentScrollFix,
    ...
    componentDidMount() {
      console.log(this.props.heightAboveComponentScrollFix,"MMMMMMM")
    ...
    _scrollToFocusedInputWithNodeHandle = (
      ...
      console.log('fix', this.props.heightAboveComponentScrollFix, this.props.enableOnAndroid)
      this.scrollToFocusedInput(
        reactNode,
        extraHeight + this.props.extraScrollHeight+ this.props.heightAboveComponentScrollFix,
